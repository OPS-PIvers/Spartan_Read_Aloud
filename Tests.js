 ...
 * To run: Select this function in the Apps Script editor and click Run.
 */
function runUnitTests() {
  Logger.log('--- STARTING UNIT TESTS ---');

  try {
    testParseHtmlToChunks();
  ...
  Logger.log('--- FINISHED UNIT TESTS ---');
}
...
/**
 * Asserts that two values are equal (using JSON.stringify for objects).
...
/**
 * Tests the parseHtmlToChunks function.
 */
function testParseHtmlToChunks() {
  Logger.log('Testing parseHtmlToChunks...');
